...
static const uint16_t crc16_table[256] = {
    ...
    0x48c4, 0x58e5, 0x68e6, 0x78a7, 0x0840, 0x1861, 0x2802, 0x3823,
    ...
    0x1080, 0x0081, 0x30c2, 0x20e3, 0x5004, 0x4025, 0x7046, 0x6067,
...
void char_to_uint32(unsigned char *buf, int len, uint32_t *crc)
{
    ...
    {
        l = buf[i + 3] << 24 | buf[i + 2] << 16 | buf[i + 1] << 8 | buf[i] << 0;
        crc[j] = l;
        j++;
    }
}
