 ...
 */
static inline void gpio_enable_port_interrupt_with_mask(GPIO_Type *ptr, uint32_t port, uint32_t mask)
{
 ...
 */
static inline void gpio_disable_port_interrupt_with_mask(GPIO_Type *ptr, uint32_t port, uint32_t mask)
{
